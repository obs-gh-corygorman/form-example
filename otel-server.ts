...
// Configuration
const serviceName = "form-example-server";
...
// Export tracer and meter - these will be available after initialization
export const getTracer = () => trace.getTracer(serviceName);
export const getMeter = () => metrics.getMeter(serviceName);
