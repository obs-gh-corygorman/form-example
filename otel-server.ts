...
// Configuration
const serviceName = "form-example"; // Next.js form application
...
// Export functions to get tracer and meter after initialization
...
export function initOtel() {
  try {
    ...
    logger.emit({
      ...
      severityText: "INFO",
      body: "OpenTelemetry SDK started for Next.js form application",
    });
  } catch (error) {
    logger.emit({
