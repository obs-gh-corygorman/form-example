...
// Configuration
const serviceName = "form-example-client"; // Updated for this specific client service

// Next.js environment variables (must be prefixed with NEXT_PUBLIC_)
const otlpEndpoint =
...
export function initOtel() {
  try {
    ...
    logger.emit({
      ...
      severityText: "INFO",
      body: "OpenTelemetry Web SDK started for form-example client",
    });
  } catch (error) {
    logger.emit({
